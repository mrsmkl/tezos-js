...
class type data = object
  ...
  method storagetype : Js.js_string Js.t Js.readonly_prop
  method input : Js.js_string Js.t Js.readonly_prop
end

let execute (dta : data Js.t) =
(*  let dta : data Js.t = Js.Unsafe.coerce obj in *)
...
class type exported = object
  method addFloat : (float -> float -> float) Js.callback Js.writeonly_prop
  method printInt : (int -> unit) Js.callback Js.writeonly_prop
